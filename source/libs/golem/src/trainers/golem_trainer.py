...
#--------
from libs.golem.src.utils.dir import create_dir 
...
class GolemTrainer:
    ...
    def train(self, model, X, num_iter, checkpoint_iter=None, output_dir=None):
        ...
        print("Started training for {} iterations.".format(num_iter))
    ...
    def train_checkpoint(self, i, score, likelihood, h, B_est, output_dir):
        ...
        print("[Iter {}] score {:.3E}, likelihood {:.3E}, h {:.3E}".format(i, score, likelihood, h))
