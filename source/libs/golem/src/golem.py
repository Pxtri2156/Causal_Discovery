import os
from libs.golem.src.models import GolemModel
from libs.golem.src.trainers import GolemTrainer
...
if __name__ == '__main__':
    ...
    from data_loader import SyntheticDataset, ProteinSignalDataset
    ...
    dataset = ProteinSignalDataset(n, d, graph_type, degree,
                               noise_type, B_scale, seed=1)
